...
class Processor
{
    ...
    {
        return [
            $this->schema->objectClassComputer()    => \libs\Adldap\Models\Computer::class,
            $this->schema->objectClassContact()     => \libs\Adldap\Models\Contact::class,
            $this->schema->objectClassPerson()      => \libs\Adldap\Models\User::class,
            $this->schema->objectClassGroup()       => \libs\Adldap\Models\Group::class,
            $this->schema->objectClassContainer()   => \libs\Adldap\Models\Container::class,
            $this->schema->objectClassPrinter()     => \libs\Adldap\Models\Printer::class,
            $this->schema->objectClassOu()          => \libs\Adldap\Models\OrganizationalUnit::class,
        ];
    }
