...
namespace libs\Adldap\Connections;

use libs\Adldap\Auth\Guard;
...
use libs\Adldap\Models\Factory as ModelFactory;
use libs\Adldap\Schemas\Schema;
use libs\Adldap\Search\Factory as SearchFactory;
